...
import type { VideoItem, VideosResponse, VideoStatusResponse } from "./types/video";
...
export default function HomePage() {
  ...
  const statusQuery = useQuery({
    ...
    enabled: Boolean(selectedVideoId && selectedVideo && selectedVideo.status !== "ready" && selectedVideo.status !== "failed"),
  ...
  const combinedError = (videosQuery.error as Error | null)?.message ?? playerError;
  ...
  return (
    <main className="appShell">
      ...
      <section className="appBody">
        <VideoSidebar videos={videos} selectedVideoId={selectedVideoId} onSelectVideo={setSelectedVideoId} />

        <section className="mainContent">
          <h2 className="videoTitle">{selectedVideo?.title ?? "Select or upload a video"}</h2>
